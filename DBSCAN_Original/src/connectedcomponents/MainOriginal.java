...
public class MainOriginal {
    ...
    public static void writeStats(String outFolder, int numOfIterations, long runTimeInMs, long ssjTimeInMs, long preProcessTimeInMs, long fccTimeInMs, int minPts, float epsilon, long nrOfClusters, long mapOutputB, long reduceInputR, long reduceShuffleB, int nrReducers, int numOfReduceTasks) {
        ...
        try {
            // Create file
            FileWriter fstream = new FileWriter(outFolder + "/stats" + "_" + "DBSCAN" +"_"+"Ori" + "_" + minPts + "_" + epsilon + "_" + nrReducers + ".txt");
...
// Similarity Join 
        ...
        Job jobSS;
        confPre0.setInt(MainOriginal.PROPERTY.MINPTS.name(), minPts);
        confPre0.setFloat(MainOriginal.PROPERTY.EPSILON.name(), epsilon);
...
//Similarity Join
            ...
            jobSS.setJarByClass(MainOriginal.class);
            ...
            jobSS.setMapperClass(SimilarityMapper.class);
            ...
            jobSS.setReducerClass(SimilarityReducer.class);
            ...
            try {
                ...
                Logger.getLogger(MainOriginal.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            Job jobpre1;
            confPre1.setInt(MainOriginal.PROPERTY.MINPTS.name(), minPts);
            jobpre1 = new Job(confPre1, "Distinguish core and non-core vertices");
            confPre1 = jobpre1.getConfiguration();
            jobpre1.setJarByClass(MainOriginal.class);
            jobpre1.setInputFormatClass(EdgeFileInputFormat.class);
            FileInputFormat.addInputPath(jobpre1, new Path(args[1] + "/0" + "/part*"));
//            try {
...
//
            // Mapper settings
            jobpre1.setMapperClass(PreEdgeMapper.class);
            jobpre1.setMapOutputKeyClass(IntWritable.class);
            jobpre1.setMapOutputValueClass(IntWritable.class);

            // Reducer settings
            jobpre1.setReducerClass(PreEdgeReducer.class);
...
//
            ...
            jobpre2.setJarByClass(MainOriginal.class);
            // InOut settings
...
//*/
        while (!converged) {
            ...
            jobCC.setJarByClass(MainOriginal.class);
...
//                job.waitForCompletion(true);
            ...
            cnt = counters.findCounter(MainOriginal.CONVERGENCE_CNT.CONVERGENCE);
...
// collect statistics regarding each cluster and how many nodes it has
        ...
        jobStats.setJarByClass(MainOriginal.class);
        ...
        cnt = counters.findCounter(MainOriginal.Stats.STATS);
